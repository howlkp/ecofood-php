...
if ( !isLoggedIn() ) {
  //If they are not, prompt user with a message
...
$logged_in_user = mysqli_fetch_assoc($results);
			if ($logged_in_user['user_type'] !== 'distributor') {

        $_SESSION[ 'msg' ] = "You must be a distributor to use this portal";
        //Then redirect them to the login screen.
        header( 'location: login.php' );
			}
      ...
      <div class="col-lg-12 mb-4 mt-2 text-center"> 
        ...
        <div class="profile_info">
          <div>
            ...
            <h3> <i  style="color: #888;">(<?php echo ucfirst($_SESSION['user']['user_type']); ?>)</i> <br>
              <a href="index.php?logout='1'" style="color: red;">logout</a> </h3>
            <?php endif ?>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-lg-8 mx-auto text-left offset-lg-0">
        ...
        <form name="form" method="post" action="">
          ...
          <p>
            <input class="btn btn-secondary add"name="submit" type="submit" value="Submit" />
          </p>
        </form>
      </div>
    </div>
